<template>
    <Media :kind="'video'" :isMuted="(true)" :src="currentVideo" :poster="'https://peach.blender.org/wp-content/uploads/title_anouncement.jpg?x11217'" :autoplay="true" :controls="false" :loop="false" :ref="'player'" @pause="pause()" @ended="ended()" @waiting="waiting()"
        @stalled="stalled()" id="player">
    </Media>
</template>
